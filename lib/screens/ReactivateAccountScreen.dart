...
import 'package:apptravella/screens/ReactivateSuccessScreen.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => const ReactivateSuccessScreen()),
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
                response.data['message'] ?? 'Failed to reactivate account'),
